                ...
                <div class="container">	
                    <div class="card login-card">	
                        <div class="row no-gutters"  style="background-color:#222222;padding: 40px;">
                            <div class="col-lg-12 col-md-5" style="text-align: center;">
                            ...
                            <div class="row no-gutters"  style="background-color:#222222;padding: 40px;">
                               <div class="col-lg-12 col-md-5" style="text-align: center;">
                                    ...
                                    <div class="col-xs-4 wow fadeInRight" data-wow-duration="1s" data-wow-delay="450ms">	
                                        ...
                                        <div class="">จันทร์ - ศุกร์: <br>6.00 - 23.59 น.</div>
                            ...
                            <?php if (isset($_SESSION['error'])) : ?>
                                ...
                                <div class="col-lg-12 col-md-5" style="text-align: center;">
                                    <div class="row wow fadeInRight" data-wow-duration="1s" data-wow-delay="800ms">
                                        <input style="font-size: 98%;" type="text" name="names" class="form-control" placeholder="ชื่อ"><br><br>
                                        <input style="font-size: 98%;" type="email" name="emails" class="form-control" placeholder="อีเมล"><br><br>
                                        <input style="font-size: 98%;"type="text" name="phones" class="form-control" placeholder="เบอร์โทรศัพท์"><br><br>
                                        <textarea  style="font-size: 98%;"name="message" class="form-control" placeholder="ข้อความ" rows="5"></textarea><br><br><br><br>
                                        <input type="submit" name="submit"style="font-size: 98%;"  value="ส่งข้อความ" class="btn btn-block login-btn mb-4 ">
                                    </div>
                                </div>
                            </div>
                        </div>
