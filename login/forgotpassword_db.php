  ...
  <custom type=  content   name=  ampscript  >
    ...
    //
            ...
            if(mysqli_num_rows($query)==1){
                if(!$mail->Send()) {
                    array_push($errors, "ยังไม่สามารถส่งเมลล์ได้ในขณะนี้ ");
                    $_SESSION['error'] = "ยังไม่สามารถส่งเมลล์ได้ในขณะนี้ ";
                     header('location: forgotpassword.php');
                    } 
                    else {
