                      ...
                      <table cellspacing=  0   cellpadding=  0   align=  left   border=  0   width=  100%   bgcolor=  #222222  >
                        <tr>
                          <td valign=  top   align=  left   width=  100%   style=  padding-left: 25px;  >
                            ...
                            <a class=navbar-brand href=http://mistersigz.thddns.net:7572/Beebas/> <img style=  max-width: 180px; height: auto   src=  http://mistersigz.thddns.net:7572/Beebas/login/logo_1.png   alt=  logo_1   /></a>
                          </td>
                        </tr>
                      </table>
                      <table cellspacing=  0   cellpadding=  0   align=  center   border=  0   width=  100%   bgcolor=  #222222  >
                      ...
                      <custom type=  content   name=  hero_image  >
                        ...
                        <table cellspacing=  0   cellpadding=  0   align=  left   border=  0   width=  100%   bgcolor=  #222222  >
                          <tr>
                            <td valign=  top   align=  center   width=  100%   style=  padding-right: 25px; padding-left: 25px;  >
                              <img width=  100%   style=  max-width: 600px; height: auto   src=  http://mistersigz.thddns.net:7572/Beebas/login/icon-co.png  alt=  Lyft business profile   />
                            </td>
                          </tr>
                        </table>
                        <!--END HERO IMAGE-->
                        ...
                        <table width=  100%   align=  center   cellpadding=  0   cellspacing=  0   border=  0   style=  max-width: 600px;  bgcolor=  #222222>
                          <tr>
                            ...
                            <font style=color:#00CEEE face = WildWest size = 5><dd>เรียนคุณลูกค้า อีเมล $email</dd></font>
                            </td>
                          </tr>
                          <tr>
                            ...
                            <font style=color:#00CEEE face = WildWest size = 4><dd> กรุณากดปุ่ม   รีเซ็ต   ด้านล่าง เพื่อตั้งรหัสผ่านใหม่</dd></font>
                            </td>
                          </tr>
                          <tr>
