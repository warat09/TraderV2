...
<body onCopy="return false">
 ...
 <form action="register_db.php" method="POST" id="signup-form" class="signup-form">
    ...
    <div class="main">
        <br><br>
        <center><a class="navbar-brand" href="index.html"><img src="images/logo_1.png" alt="Beebacop"></a></center><br>
        ...
        <div class="form-group">
            <input type="number" class="form-control" name="tell" id="tell" placeholder="เบอร์โทรศัพท์
            "/>
        </div>
        <div class="box">
