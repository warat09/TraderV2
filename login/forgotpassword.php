            ...
            <div class="container">
                <div class="signup-content">
                    <form action ="forgotpassword_db.php" method="POST" id="signup-form" class="signup-form">
                        ...
                        <label class="cont">กรอกอีเมลเพื่อรีเซ็ตรหัสผ่าน
                          </label>
                        <div class="form-group">
                            <input type="text" class="form-input" name="email" id="email" placeholder="อีเมล"/>
                        </div>
                    ...
                    <p class="loginhere">
                         <a href="login.php" class="loginhere-link">เข้าสู่ระบบ</a><br>
                         <a href="regis.php" class="loginhere-link">สมัครสมาชิก</a>
                    </p>
                </div>
            </div>
        </section>
