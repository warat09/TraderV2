            ...
            <div class="container">
                <div class="signup-content">
                    <form action="register_db.php" method="POST" id="signup-form" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="email" class="form-input" name="con_email" id="con_email" placeholder="อีเมล">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="password" class="form-input" name="con_password" id="con_password" placeholder="รหัสผ่าน"/>
                            <span toggle="#password" class="zmdi zmdi-eye field-icon toggle-password"></span>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="box">
                            <input required id="one" type="checkbox">
                ...
                <h6>Captcha ไม่เห็นกดที่รูป <img src="./images/refresh.jpg" width="40px" onclick="cap()"></h6>
                    ...
                    <p class="loginhere">
                        สมัครสมาชิกแล้วใช่ใหม? <a href="login.html" class="loginhere-link">เข้าสู่ระบบ</a>
                    </p>
                </div>
            </div>
        </section>
