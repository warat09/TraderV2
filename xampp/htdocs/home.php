        ...
        <div class="carousel-inner">
			<div class="item active" style="background-image: url(images/slider/bg-1.jpg)"> <!-- Change Image -->
				<div class="caption">
					...
					<a data-scroll class="learn-more animated fadeInUpBig" href="login/regis.php">สมัครสมาชิก</a>
				</div>
			</div>
...
<section class="section-wrapper" id="pricing">
	<div class="pricing">
		...
		<div class="element-title">			
			<div class="row">	 		
				<div class="container">
					<h1 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="100ms"><span class="text-color">ลงทุน</span></h1>		
					<h1 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="300ms">ลงทุน BotPlus</h1>
					<h3 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="300ms">ข้อมูลการลงทุน <span class="main-color">BotPlus</span></h3>	
				</div>
			</div>
		</div>
		<!-- End Block Title -->
				...
				<div class="wrapper-pricing">
					...
					<div class="col-lg-3 col-md-3">
						...
						<h4>ขั้นต่ำ</h4>
							...
							<span class="price">1000 บาท</span>
							<ul>
                                <li>เงินลงทุนขั้นต่ำ 1000 บาท</li>
					...
					<div class="col-lg-3 col-md-3">
						...
						<h4>เริ่มต้น</h4>
							...
							<span class="price">พอร์ต 3</span>
							<ul>
								<li>พอร์ตเริ่มต้นการลงทุน</li>
                                <li>เงินลงทุนขั้นต่ำที่ 1000 บาท</li>
                                <li>เงินปันผลสูงสุดที่ 9%</li>
                                <li>สนับสนุนการบริการ</li>
                                <li>สนับสนุนและพัฒนา AI</li>
                            </ul>
						</div>
					...
					<div class="col-lg-3 col-md-3">
						...
						<h4>ทั่วไป</h4>
							...
							<span class="price">พอร์ต 2</span>
							<ul>
                                <li>พอร์ตทั่วไปการลงทุน</li>
                                <li>เงินลงทุนขั้นต่ำที่ 10000 บาท</li>
                                <li>เงินปันผลสูงสุดที่ 9%</li>
                                <li>สนับสนุนการบริการ</li>
                                <li>สนับสนุนและพัฒนา AI</li>
                            </ul>
					...
					<div class="col-lg-3 col-md-3">
						...
						<h4>เชี่ยวชาญ</h4>
							...
							<span class="price">พอร์ต 1</span>
							<ul>
								<li>พอร์ตเชี่ยวชาญการลงทุน</li>
                                <li>เงินลงทุนขั้นต่ำที่ 100000 บาท</li>
                                <li>เงินปันผลสูงสุดที่ 9%</li>
                                <li>สนับสนุนการบริการ</li>
                                <li>สนับสนุนและพัฒนา AI</li>
                            </ul>
					...
					<div class="row">
						<div class="container">	 	
							<div class="sign_form wow fadeInLeft" data-wow-duration="1s" data-wow-delay="300ms">
								...
								<br>
									<a href="doc/condition.pdf"><img src="images/download/dd.png" alt="" style="width:10%;"></a> <!-- Change Image --><br>
			...
			<div class="element-title">			
				<div class="row">	 		
					<div class="container">	 
						...
						<h1 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="300ms"><span class="main-color">ทีมงาน</span>สุดสร้างสรรค์</h1>
					</div>
				</div>
			</div>
			<!-- End Block Title -->
									...
									<div class="team-member-image">
										...
										<div class="overlay-content"> 
											<div class="team-member-social-list">
												...
												<a class="team-member-social-list-item" href="mailto:s6204062616111@email.kmutnb.ac.th"><i class="fa fa-envelope"></i></a>
											</div>
									...
									<div class="team-member-image">
										...
										<div class="overlay-content"> 
											<div class="team-member-social-list">
												...
												<a class="team-member-social-list-item" href="mailto:s6204062616120@email.kmutnb.ac.th"><i class="fa fa-envelope"></i></a>
											</div>
									...
									<div class="team-member-image">
										...
										<div class="overlay-content"> 
											<div class="team-member-social-list">
												...
												<a class="team-member-social-list-item" href="mailto:s6204062616031@email.kmutnb.ac.th"><i class="fa fa-envelope"></i></a>
											</div>
									...
									<div class="team-member-image">
										...
										<div class="overlay-content"> 
											<div class="team-member-social-list">
												...
												<a class="team-member-social-list-item" href="mailto:s6204062616201@email.kmutnb.ac.th"><i class="fa fa-envelope"></i></a>
											</div>
									...
									<div class="team-member-image">
										...
										<div class="overlay-content"> 
											<div class="team-member-social-list">
												...
												<a class="team-member-social-list-item" href="mailto:s6204062616065@email.kmutnb.ac.th"><i class="fa fa-envelope"></i></a>
											</div>
		...
		<div class="overlay">
			<div class="wrapper-block-skills">
				...
				<div class="element-title">	
					<div class="row">	 		
						<div class="container">	 		
							<h1 class="main-color wow fadeInDown" data-wow-duration="1s" data-wow-delay="300ms">ความสามารถการทำงาน</h1>
							<h3 class="white-color wow fadeInUp" data-wow-duration="1s" data-wow-delay="300ms">ประเมินความสามารถด้วยตนเอง</h3>
						</div>
					</div>
				</div>
				<!-- End Block Title -->
						...
						<div class="wrapper-count">
							<div class="col-lg-3 col-md-3">
								...
								<div class="skill wow fadeInRight" data-wow-duration="1s" data-wow-delay="300ms">
									<input type="text" class="knob" value="51">
									<h4>Web Design</h4>
								</div>
							</div>
							<div class="col-lg-3 col-md-3">
								...
								<div class="skill wow fadeInRight" data-wow-duration="1s" data-wow-delay="500ms">
									<input type="text" class="knob" value="62">
									<h4>Html5</h4>
								</div>
							</div>
							<div class="col-lg-3 col-md-3">
							...
							<div class="col-lg-3 col-md-3">
								...
								<div class="skill wow fadeInRight" data-wow-duration="1s" data-wow-delay="1100ms">
									<input type="text" class="knob" value="78">
									<h4>CSS</h4>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="wrapper-contacts-icons">	
								<div class="col-xs-4 wow fadeInRight" data-wow-duration="1s" data-wow-delay="300ms">	
									...
									<div class="">Mistersig</div>
									<div class="">ถ.พระราม6  แขวง.รัชดาภิเษก</div>
								</div>								
								<div class="col-xs-4 wow fadeInRight" data-wow-duration="1s" data-wow-delay="450ms">	
									<i class="fa fa-mobile-phone"></i>
									<div class="">จันทร์ - ศุกร์: 6.00 - 23.59 น.</div>
									<div class="">0993155880</div>
								</div>
								<div class="col-xs-4 wow fadeInRight" data-wow-duration="1s" data-wow-delay="600ms">	
									<i class="fa fa-envelope-o"></i>
									<div class="">อีเมลติดต่อ</div>
									<div class="">beebacorporation@gmail.com</div>
								</div>								
